                               ...
                               beam_type flavour, kill_method_type ktype)
{
    ...
    // If the player is charmed and hurts one of their "friends",
    // there's a chance damage will be inflicted on them (but end the charming).
    // Do this in a fineff so multiple sources of damage don't inflate the
    // escape charming. (We don't count damage done by your allies, but they
    // shouldn't be attacking the charmer either)
