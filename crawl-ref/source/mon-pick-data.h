...
{ /* Depths (OOD cap: 13)*/ \
  ...
  {  0,  5,   50, PEAK, MONS_COBALT_LICHEN },\
  {  0,  7,   50, PEAK, MONS_COBALT_LICHEN_EYESTALK },\
  {  0,  9,   50, FALL, MONS_COBALT_LICHEN_MAW },\
  {  0, 11,   50, FALL, MONS_COBALT_LICHEN_SAC },\
...
{ // The Vaults (OOD cap: 12)
  ...
  {  1,  4,  350, RISE, MONS_YAKTAUR_CAPTAIN },
  {  1,  4,  300, FLAT, MONS_YAKTAUR_FUSILIER },
