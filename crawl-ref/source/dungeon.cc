...
object_class_type item_in_shop(shop_type shop_type)
{
    ...
    case SHOP_EVOKABLES:
    {
        ...
        // (A small chance of jewellery/armour with evocable properties like blink
        // or invis might be nice, but the complexity of doing so seems not worth
        // it, and could easily be handled with a vault shop instead)
        return random_choose_weighted(
             100, OBJ_WANDS,
              50, OBJ_MISCELLANY,
