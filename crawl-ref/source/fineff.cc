...
void rockfish_disperse_fineff::fire()
{
    ...
    {
        coord_def npos = find_newmons_square_contiguous(MONS_ROCKFISH, posn, 3, false);
        if (!in_bounds(npos))
            continue;
        ...
        auto mg = mgen_data(MONS_ROCKFISH, spawn_beh, npos, foe,
    ...
    else
    {
        ...
        change_monster_type(defend->as_monster(), MONS_ROCKFISH, false);
