...
magical effects or spells (such as 'Invisibility', 'Irradiate' or 'Lunar
Fissure') also cause contamination as a side-effect even when successful. A
single use of these effects is safe on its own (with the exception of 'Lunar
Fissure), but multiple uses in short succession, or usage with existing
contamination from other sources can cause dangerous levels of contamination.
