...
magical effects or spells (such as 'Invisibility', 'Irradiate' or the 'moonstone
moondial') also cause contamination as a side-effect even when successful. A
single use of these effects is safe on its own (with the exception of the
moondial at full power), but multiple uses in short succession, or usage with
